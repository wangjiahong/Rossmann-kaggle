...
train = pd.read_csv("../input/Rossmann/train.csv", parse_dates=[2], dtype=types)
test = pd.read_csv("../input/Rossmann/test.csv", parse_dates=[3], dtype=types)
store = pd.read_csv("../input/Rossmann/store.csv")
...
# 0.14471 number 2660 amount all 3000 teams
